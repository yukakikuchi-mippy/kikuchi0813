const app = new Vue({
  ...
  methods: {
    ...
    addData: async function() {
      ...
      //INSERT用のAPIを呼び出し
      const response = await axios.post('https://m3h-yukakikuchi-functionapiapp0730.azurewebsites.net/api/INSERT?',param);
    ...
    readData: async function() {
      //SELECT用のAPIを呼び出し      
      const response = await axios.get('https://m3h-yukakikuchi-functionapiapp0730.azurewebsites.net/api/SELECT?');
    ...
    checkSession: async function() {
      ...
      try {
        ...
        const response = await axios.post('https://m3h-yukakikuchi-functionapiapp0730.azurewebsites.net/api/CheckSession?', {
          SessionId: sessionId
        });
